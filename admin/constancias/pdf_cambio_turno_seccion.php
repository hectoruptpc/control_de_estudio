...
$pdf->SetFont('Arial','B',12); $pdf->Cell(0,8,txt('CAMBIO DE TURNO / SECCIÓN'),0,1,'C'); $pdf->Ln(8);
$pdf->SetFont('Arial','',11);
$pdf->MultiCell(0,6,txt('Se certifica que ' . strtoupper($est['nombre']) . ' (C.I. ' . $est['idusuario'] . ') ha solicitado y efectuado cambio de turno/sección de acuerdo con la gestión académica.'),0,'J');
$pdf->Ln(12); $pdf->MultiCell(0,6,txt('Turno/Sección anterior: ...........  Nuevo Turno/Sección: ............'),0,'J');
$pdf->Ln(30); $pdf->SetFont('Arial','B',10); $pdf->Cell(0,4,txt('Departamento de Control de Estudios'),0,1,'C');
ob_end_clean(); $pdf->Output('I','Cambio_Turno_Seccion_' . $est['idusuario'] . '.pdf'); exit();
