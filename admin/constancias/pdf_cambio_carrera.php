...
$pdf->SetFont('Arial','B',12); $pdf->Cell(0,8,txt('CAMBIO DE CARRERA'),0,1,'C'); $pdf->Ln(8);
$pdf->SetFont('Arial','',11);
$pdf->MultiCell(0,6,txt('Se hace constar que ' . strtoupper($est['nombre']) . ' (C.I. ' . $est['idusuario'] . ') ha solicitado y/o autorizado el cambio de carrera conforme a los registros institucionales.'),0,'J');
$pdf->Ln(12); $pdf->MultiCell(0,6,txt('Carrera anterior: ................................  Carrera nueva: ................................'),0,'J');
$pdf->Ln(30); $pdf->SetFont('Arial','B',10); $pdf->Cell(0,4,txt('Departamento de Control de Estudios'),0,1,'C');
ob_end_clean(); $pdf->Output('I','Cambio_Carrera_' . $est['idusuario'] . '.pdf'); exit();
