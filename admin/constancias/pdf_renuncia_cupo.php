...
$pdf->SetFont('Arial','B',12); $pdf->Cell(0,8,txt('RENUNCIA DE CUPO'),0,1,'C'); $pdf->Ln(8);
$pdf->SetFont('Arial','',11);
$pdf->MultiCell(0,6,txt('Se deja constancia que el(la) estudiante ' . strtoupper($est['nombre']) . ' (C.I. ' . $est['idusuario'] . ') ha presentado renuncia de cupo en la institución.'),0,'J');
$pdf->Ln(12); $pdf->MultiCell(0,6,txt('Motivo: ............................................................'),0,'J');
$pdf->Ln(30); $pdf->SetFont('Arial','B',10); $pdf->Cell(0,4,txt('Departamento de Control de Estudios'),0,1,'C');
ob_end_clean(); $pdf->Output('I','Renuncia_Cupo_' . $est['idusuario'] . '.pdf'); exit();
