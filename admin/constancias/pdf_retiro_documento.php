...
if ($id_estudiante > 0) {
    ...
    // Consulta para la carrera (usando tu función existente)
...
// Función para convertir la fecha actual a formato legal
...
// Bloque de Identidad del Estudiante
...
$pdf->SetFont('Arial', 'B', 11);
$pdf->Write($lh, txt($fecha['anio_num']));
$pdf->SetFont('Arial', '', 11);
$pdf->Write($lh, txt("."));
...
ob_end_clean();
$pdf->Output('I', "Retiro_Documento_".$cedula_est.".pdf");
exit();