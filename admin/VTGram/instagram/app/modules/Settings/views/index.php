		...
		<form role="form" method="POST" data-redirect="settings" enctype="multipart/form-data">
            <div class="box box-solid section-dashborad-head mb0">
                <div class="box-header with-border section-head">
                    <i class="fa fa-key"></i> <?=l('License')?></h3>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active">
                                ...
                                <?php if(get('error')){?>
                                <p>Click <a href="http://vtcreators.com/products/vtgram.php" target="_blank">here</a> to buy this product</p>
                                <br/>
                                <?php }?>
                            </div>
                        </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="name"><?=l('Google map API key')?> (<a href="https://youtu.be/zWoS6CC9rjo" target="_blank">Video guide</a>)</label>
            ...
            <div class="box-body">
				...
				<div class="tab-content" style="border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; border-radius: 0 0 10px 10px;">
                    <div id="facebook" class="col-md-12 tab-pane fade in active">
                        <div class="form-group">
                    ...
                    <div id="google" class="col-md-12 tab-pane fade">
                        <div class="form-group">
                    ...
                    <div id="twitter" class="col-md-12 tab-pane fade">
                        <div class="form-group">
