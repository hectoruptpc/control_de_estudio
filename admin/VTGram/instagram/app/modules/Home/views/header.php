	...
	<div class="header_top">
		<div class="wrap" style="width: 100%;">
			...
			<div class="btn-group btn-group-sm right btn-language">
		        <button type="button" class="btn dropdown-toggle btn-default" data-toggle="dropdown" aria-expanded="false"><?=strtoupper(LANGUAGE)?>
			    ...
			    <ul class="menu-main">
			    	...
			    	<li><a href="#" title=""><?=l('instagram-tools')?> <i class="fa fa-caret-down" aria-hidden="true"></i></a>
			    		<ul class="sub-menu">
			    			...
			    			<li><a href="<?=PATH."instagram/auto_comment"?>"><?=l('auto-comments')?></a></li>
			    			<li><a href="<?=PATH."instagram/auto_like"?>"><?=l('auto-likes')?></a></li>
			    			...
			    			<li><a href="<?=PATH."instagram/comment"?>"><?=l('comments')?></a></li>
			    			<li><a href="<?=PATH."instagram/like"?>"><?=l('likes')?></a></li>
			    		</ul>
			    	</li>
