<div class="wrap">
	<div class="section-schedule">
		<div class="tab-head">
			<span class="title"> <i class="fa fa-commenting text-primary" aria-hidden="true"></i> <?=l('Auto Direct Message')?></span>
			<div class="right">
				...
				<div class="btn-group">
			        ...
			        <ul class="dropdown-menu">
			            <li><a class="btnActionList" data-action="delete" data-type="message" href="javascript:void(0);"><?=l('Delete All')?></a></li>
			        </ul>
			    </div>
			</div>
		</div>
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="row">
					...
					<div class="list_load" data-page="0" data-action="<?=PATH."Instagram_direct_message/ajax_page"?>"></div>
					<?php }else{?>
					<div class="col-md-12">
		        	...
		        	<div class="btn-group left">
			        	<div class="form-inline" style="display:inline-block;">
						    <div class="form-group">
						    	<button type="button" class="btn btn-default btnSearchScrap" data-type="following"><?=l('get-self-users-following')?></button>
						    	<button type="button" class="btn btn-default btnSearchScrap" data-type="followers"><?=l('get-self-users-followers')?></button>
						    </div>
						</div>
					</div>
		        </div>
