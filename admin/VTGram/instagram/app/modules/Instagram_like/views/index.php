<div class="wrap">
	<div class="section-schedule">
		<div class="tab-head">
			<span class="title"> <i class="fa fa-heartbeat text-info" aria-hidden="true"></i> <?=l('Like')?></span>
			<div class="right">
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="row">
					...
					<div class="list_load" data-page="0" data-action="<?=PATH."Instagram_like/ajax_page"?>"></div>
					<?php }else{?>
					<div class="col-md-12">
				...
				<div class="schedule-content">
					...
					<div class="schedule-option">
						...
						<div class="btn-group right">
						    <button type="button" class="btn btn-success btn-flat btnSaveScheduleLike1"><i class="fa fa-clock-o" aria-hidden="true"></i> <?=l('schedule')?></button>
						</div>
