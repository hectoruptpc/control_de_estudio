<div class="wrap">
	<div class="section-schedule">
		<div class="tab-head">
			<span class="title"> <i class="fa fa-undo text-info" aria-hidden="true"></i> <?=l('Auto Follow Back')?></span>
			<div class="right">
				...
				<a href="<?=PATH."instagram/follow/log?type=followback"?>" class="btn btn-danger btn-flat"><i class="fa fa-history" aria-hidden="true"></i> <?=l('History')?></a>
				<div class="btn-group">
			        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><?=l('action')?>
			            <span class="fa fa-caret-down"></span></button>
			        <ul class="dropdown-menu">
			            <li><a class="btnActionList" data-action="repost" data-type="followback" href="javascript:void(0);"><?=l('Start All')?></a></li>
			            <li><a class="btnActionList" data-action="cancel" data-type="followback" href="javascript:void(0);"><?=l('Stop All')?></a></li>
			            <li><a class="btnActionList" data-action="delete" data-type="followback" href="javascript:void(0);"><?=l('Delete All')?></a></li>
			        </ul>
			    </div>
			</div>
		</div>
        ...
        <form class="formList">
			<div class="schedule-list-posts">
				<div class="row">
					...
					<div class="list_load" data-page="0" data-action="<?=PATH."Instagram_follow/ajax_followback_page"?>"></div>
					<?php }else{?>
					<div class="col-md-12">
        ...
        <div class="modal-content section-schedule">
        	<form class="formSchedule">
				...
				<div class="schedule-content">
					...
					<textarea placeholder="<?=l('send-direct-message')?>" name="description" class="post-message"></textarea>
