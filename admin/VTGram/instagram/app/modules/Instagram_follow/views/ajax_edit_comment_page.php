							    ...
							    <div class="row">
							    	<div class="form-group col-md-12 mb0">
					                    ...
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" checked="true" name="type" value="1" <?=($item->title == 1)?"checked":""?>> <span style="margin-right: 20px;">&nbsp;&nbsp;<i class="fa fa-hashtag" aria-hidden="true"></i> <?=l('Like by hashtags')?></span>
					                    </span>
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" name="type" value="2" <?=($item->title == 2)?"checked":""?>> <span style="margin-right: 20px;">&nbsp;&nbsp;<i class="fa fa-map-marker" aria-hidden="true"></i> <?=l('Like by location')?></span>
					                    </span>
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" name="type" value="3" <?=($item->title == 3)?"checked":""?>> &nbsp;&nbsp;<i class="fa fa-user" aria-hidden="true"></i> <?=l('Like by username')?>
					                    </span>
					                </div>
								    <div class="form-group col-md-12">
