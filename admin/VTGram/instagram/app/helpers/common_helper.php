...
if (!function_exists('VideoDownloader')) {
	function VideoDownloader($url = "") { 
		require_once(APPPATH."libraries/YouTubeDownloader.php" );
		require_once(APPPATH."libraries/VimeoDownloader.php" );
		require_once(APPPATH."libraries/LinkHandler.php" );
		...
		if(!empty($downloader)){
			...
			{
			    return $downloader->getVideoDownloadLink();
			}else{
				return false;
			}
		}else{
