...
--
-- Database: `project_instagram_tool`
--
...
--
-- Table structure for table `tbl_instagram_follow`
--
...
--
-- Table structure for table `tbl_instagram_save`
--
...
INSERT INTO `tbl_settings` (`id`, `title`, `description`, `keywords`, `logo`, `theme`, `register`, `maximum_account`, `upload_max_size`, `auto_active_user`, `default_language`, `default_timezone`, `default_deplay`, `minimum_deplay`, `purchase_code`, `google_api_key`, `facebook_id`, `facebook_secret`, `google_id`, `google_secret`, `twitter_id`, `twitter_secret`) VALUES
(1, 'VTGram - Instagram Tools For Marketing', 'VTGram - Instagram Tools For Marketing', 'VTGram - Instagram Tools For Marketing', 'assets/img/logo.png', NULL, 1, 1, 30, 0, 'en', 'admin_timezone', 180, 180, 'ITEM-PURCHASE-CODE', 'admin_google_api_key', '', '', '', '', '', '');
...
(1, 1, NULL, 'direct', 'admin_fullname', 'admin_email', 'admin_password', 'admin_timezone', 1, 1, '2017-03-18 23:05:09', '2016-09-27 00:00:00');
...
--
-- Indexes for table `tbl_instagram_account`
--
ALTER TABLE `tbl_instagram_account`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_instagram_follow`
--
ALTER TABLE `tbl_instagram_follow`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_instagram_save`
--
...
--
-- AUTO_INCREMENT for table `tbl_instagram_account`
--
ALTER TABLE `tbl_instagram_account`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_instagram_follow`
--
ALTER TABLE `tbl_instagram_follow`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_instagram_save`
--
ALTER TABLE `tbl_instagram_save`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
