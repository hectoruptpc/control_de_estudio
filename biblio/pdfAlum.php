...
$pdf->Cell(1);
$pdf->MultiCell(0,10,utf8_decode('Listado de Graduados') ,0, 'C');
...
$pdf->SetFillColor(79,98,142);
$pdf->SetDrawColor(0,0,0);
$pdf->MultiCell(30,10,utf8_decode('Tomo') ,'RTBL', 'C',true);
...
$pdf->SetFillColor(79,98,142);
$pdf->SetDrawColor(0,0,0);
$pdf->MultiCell(30,10,utf8_decode('Folio') ,'RTBL', 'C',true);
/*
$pdf->Ln(-10);
$pdf->Cell(151);
$pdf->SetFillColor(79,98,142);
...
$pdf->SetFillColor(79,98,142);
$pdf->SetDrawColor(0,0,0);
$pdf->MultiCell(40,10,utf8_decode('Fecha del grado') ,'RTBL', 'C',true);
...
$pdf->SetFillColor(79,98,142);
$pdf->SetDrawColor(0,0,0);
$pdf->MultiCell(80,10,utf8_decode('Fecha del registro') ,'RTBL', 'C',true);
...
$pdf->SetDrawColor(0,0,0);
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(30,$alturaMaxima,utf8_decode($tomo) ,'LBRT', 'C',true);
...
$pdf->SetDrawColor(0,0,0);
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(30,$alturaMaxima,utf8_decode($folio) ,'LBRT', 'C',true);
/*
$pdf->Ln(-$alturaMaxima);
$pdf->Cell(151);
$pdf->SetFillColor(255,255,255);
...
$pdf->SetDrawColor(0,0,0);
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(40,$alturaMaxima,utf8_decode($fechaG) ,'LBRT', 'C',true);
...
$pdf->SetDrawColor(0,0,0);
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(80,$alturaMaxima,utf8_decode($fecha) ,'LBRT', 'C',true);
...
$pdf->SetDrawColor(0,0,0);
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(310,10,utf8_decode('Disculpe | no hay resultados'),'LBRT', 'C', true);
