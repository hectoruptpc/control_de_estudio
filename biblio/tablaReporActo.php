...
<div class="container" >
  <h3 class="mt-5">Reporte de Tipo de Acto





  <a href="pdfActo.php" target="_blank">
    <button class="pdf">
...
<div id="contenedor" class="dataTables_wrapper no-footer" url="contenidoTablaReporActo.php">
