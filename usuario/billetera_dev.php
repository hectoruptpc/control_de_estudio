...
<input pattern="[0-9]{6,8}" min="100000" max="99999999" title = "Indique el monto"  type="number" class="form-control" id="monto" aria-describedby="monto" placeholder="Monto Transferido" name="monto" value="';
echo $mmo;
echo '" required>
<div class="invalid-feedback">Debe indicar el monto transferido Minimo 100.000 Bs Maximo 99.999.999 Bs</div>
</div>
...
<button type="submit" class="btn btn-primary" name="pago_billetera_btn"> <i class="far fa-money-bill-alt"></i> Enviar</button>
