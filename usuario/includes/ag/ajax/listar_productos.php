...
!-->
<a href="#" data-target="#editProductModal" class="edit" data-toggle="modal" data-first_name='<?php echo $first_name; ?>' data-numero='<?php echo $numero ?>' data-id='<?php echo $id; ?>'><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
...
echo '<div class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Lo sentimos no hay datos en su agenda.</div>';
}
}
?>
