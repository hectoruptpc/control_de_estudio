...
require('db.php');
$sql = "UPDATE pensum SET  pensum = '$pensum' , descripcion = '$descripcion' , descripcion2 = '$descripcion2' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_pensum_lista.php">
      <fieldset>
