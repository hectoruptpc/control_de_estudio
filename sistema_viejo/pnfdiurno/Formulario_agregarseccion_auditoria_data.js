...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_agregarseccion_auditoria_data.php?job=get_companies",
  	"columns": [
    { "data": "accion"},
    { "data": "cod"},
    { "data": "usuario"},
  ...
  // Delete agregarseccion_auditoria
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la agregarseccion_auditoria?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_agregarseccion_auditoria_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_agregarseccion_auditoria_eliminar.php",{accion: "Borrar", id:valor},function(res){
