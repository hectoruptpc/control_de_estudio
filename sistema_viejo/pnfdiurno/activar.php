...
$sql = "UPDATE alumno SET  actividad = '1' WHERE id ='".$id."'";
...
include 'menu.php';
 ...
 <form class="form-horizontal" id="effect2" method="post" action="activar alumno.php">
  <fieldset>
 <div class="form-group" id="titulo_formulario"> 
    <label id="titulo_formulario"><span class="glyphicon glyphicon-thumbs-up"></span> Activacion exitosa</label>
</div>
...
echo "error al activar alumno: ".$conn->error;
}
