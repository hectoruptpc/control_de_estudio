     ...
     <td><a href="rcambio_carrera.php?action=editar&id=<?php echo $row["id"]; ?>"  data-toggle="tooltip" title="Editar datos" class="btn btn-sm btn-info" style="background: #FF9800;width:45px"><span class="glyphicon glyphicon-pencil"></span></a></td>
     </td>                 
     </tr>
     <?php            
