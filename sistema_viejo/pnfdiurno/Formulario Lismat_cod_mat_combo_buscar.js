...
$.ajax({
    data:parametros,
    type: "POST",
    url: "mostrar_seccion_tabla2.php",        
...
function mostrar_carrera_tabla(val1,val2,val3){             
 var parametros = {
   "cedula":val1,
   "carrera":val2,
   "pensum":val3
...
$.ajax({
    data:parametros,
    type: "POST",
    url: "mostrar_seccion_tabla3.php",        
    success: function(datos)
    {   
      $('#editable_table').html(datos);
  }
...
function mostrar_materia_tabla(val1,val2,val3){            
 var parametros = {
   "cedula":val1,
   "cod_mat":val2,
   "pensum":val3
...
$.ajax({
    data:parametros,
    type: "POST",
    url: "mostrar_seccion_tabla4.php",        
    success: function(datos)
    {  
      $('#editable_table').html(datos);
  }
