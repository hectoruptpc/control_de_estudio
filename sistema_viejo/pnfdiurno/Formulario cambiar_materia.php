		...
		<form class="form-horizontal" name="informacion" id="effect2" method="post" action="">
			<fieldset>
				<div class="form-group" id="titulo_formulario"> 
					<label id="titulo_formulario"><span class="glyphicon glyphicon-list"></span> Cambiar Materia</label>
				</div>
				...
				<p> 
					...
					<div class="form-group">
						<div class="col-md-12" style="margin-left: 10px;">
							<label for="cod_mat">Materia actual</label>  
					...
					<div class="form-group">
						<div class="col-md-12" style="margin-left: 10px;">
							<label for="cod_mat2">Materia nuevo</label>  
							<input type="hidden" id="cod_mat2" name="cod_mat2">                   
						</div>

						<div class="selector-cod_mat2" style="margin-left: 25px;">   
							<select></select>   
						</div>
					</div>
