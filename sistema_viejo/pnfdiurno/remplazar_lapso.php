...
$result = mysqli_query($conn, $sql);
 ...
 /////////****************////////////////         
  $sql = "UPDATE notas SET `lapso` = REPLACE(`lapso`, '".$lapso."', '".$lapso2."') WHERE `cod_mat`='".$cod_mat."' AND `cod_doc`='".$cod_doc."' AND `seccion`='".$seccion."'";
  
  $result = $conn->query($sql);

  $sql = "UPDATE agregarseccion SET `lapso` = REPLACE(`lapso`, '".$lapso."', '".$lapso2."') WHERE `cod_mat`='".$cod_mat."' AND `cod_doc`='".$cod_doc."' AND `seccion`='".$seccion."'";
  
  $result = $conn->query($sql);
 /////////****************//////////////// 
  

  $sql = "SELECT notas.codigo,notas.cod_mat,notas.cod_doc,notas.lapso,notas.seccion,alumno.nombre FROM notas,alumno where notas.cod_mat='".$cod_mat."' and notas.seccion='".$seccion."' and notas.lapso='".$lapso2."' and notas.cod_doc='".$cod_doc."' and notas.codigo=alumno.cedula";
