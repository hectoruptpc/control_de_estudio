...
$sql = "SELECT DISTINCT alumno.cedula,alumno.nombre,alumno.actividad FROM `notas`,alumno WHERE alumno.cedula=notas.codigo and notas.`carrera` = '".$carrera."' AND notas.`lapso`='".$lapso."' AND notas.seccion= '".$seccion."' ORDER BY alumno.nombre ASC";
