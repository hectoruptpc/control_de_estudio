...
$carrera= substr($_POST["pensum2"], 0, 1);       
...
$xls->getActiveSheet()->setCellValue('B'.$i, "LISTADO DE ALUMNOS DEL ".$carrera_a1);
...
include('db.php');    
$sql = "SELECT DISTINCT alumno.cedula,alumno.nombre,alumno.actividad,notas.lapso FROM alumno,notas WHERE notas.carrera='".$carrera."' and actividad=1 and notas.codigo=alumno.cedula ORDER BY nombre ASC";// 
...
if ($resultado->num_rows > 0) {               
	...
	$xls->getActiveSheet()->setCellValue('B'.$i,$carrera." carrera");
}
