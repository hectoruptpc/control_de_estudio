...
$sql = "INSERT INTO nota_auditoria(accion,cod,usuario,nota,hora,fecha) VALUES ('$accion','$cod','$usuario','$nota','$hora','$fecha');";
$result = mysqli_query($conn, $sql);

$sql = "INSERT INTO nota(nota) VALUES ('$nota');";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_nota_lista.php">
      <fieldset>
