...
<body>
	<div class="container" id="marco" style="width:45%">
		<form class="form-horizontal" id="effect2" method="post" action="SERVICIOS_SECCION4_6.php">
			<fieldset>
				<div class="form-group" id="titulo_formulario"> 
					<label id="titulo_formulario"><span class="glyphicon glyphicon-tasks"></span> Seleccione una Materia <span class="badge" style="background:#F0F0F0;color: #0C4783;font-weight:bold">06</span></label>
				</div>
	...
	$('#cod_mat').val(v);    
			...
			buscarmateria($("#pensum").val(),$("#trayecto").val());  
