...
<div class="form-group" id="marco" style="width:500px;">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_directivos_edit.php">
        <fieldset>
            <div class="form-group" id="titulo_formulario">
                <label id="titulo_formulario"><span class="glyphicon glyphicon-pencil"></span> Editar directivos</label>
            </div>
<p>
...
<div class="form-group" style="padding-left: 15px;padding-right:20px">
  <div class="col-md-12" style="width: 100%;margin-left: 0%;margin-top:0px">
    ...
    <input id="cargo" name="cargo" type="text" placeholder="Cargo" class="form-control" value="<?php echo $cargo;?>">
  </div>
</div>
...
<div class="form-group" style="padding-left: 15px;padding-right:20px">
  <div class="col-md-12" style="width: 100%;margin-left: 0%;margin-top:0px">
    ...
    <input id="lugar" name="lugar" type="text" placeholder="Lugar" class="form-control" value="<?php echo $lugar;?>">
  </div>
</div>
...
<div class="form-group" style="padding-left: 15px">
  <div class="col-md-12">
    ...
    <a href="Formulario_directivos_lista.php" class="btn btn-primary" style="background: #0C4783;width:120px"><span class="glyphicon glyphicon-arrow-left"></span> Volver</a>
  </div>
</div>
