...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_aula_data.php?job=get_companies",
  	"columns": [
    { "data": "descrip"},
    { "data": "aula"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_aula_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_aula_eliminar.php",{accion: "Borrar", id:valor},function(res){
