...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_graduacion_data.php?job=get_companies",
  	"columns": [
    { "data": "cedula"},
    { "data": "nombre"},
    { "data": "marca"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_graduacion_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_graduacion_eliminar.php",{accion: "Borrar", id:valor},function(res){
