            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Create edit button.
                        if (settings.editButton) {
                            editButton = '<button type="button" class="tabledit-edit-button ' + settings.buttons.edit.class + '" style="float: none;width: 40px;background: rgba(255, 152, 0,1);color:#FFFFFF;">' + settings.buttons.edit.html + '</button>';
                        }

                        // Create delete button.
                        if (settings.deleteButton) {
                            deleteButton = '<button type="button" class="tabledit-delete-button ' + settings.buttons.delete.class + '" style="float: none;width: 40px;background: rgba(229, 28, 35,1);color:#FFFFFF;">' + settings.buttons.delete.html + '</button>';
                            confirmButton = '<button type="button" class="tabledit-confirm-button ' + settings.buttons.confirm.class + '" style="display: none; float: none;width: 90px">' + settings.buttons.confirm.html + '</button>';
                        }
