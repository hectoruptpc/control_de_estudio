...
<body>
	<div class="container" id="marco" style="width:45%">
		<form class="form-horizontal" id="effect2" method="post" action="LISTA DE GRADUADOS_C.php">
			<fieldset>
						...
						<td>
							<div class="form-group">
								<div class="col-md-12" style="width: 200px;margin-left: 0px;margin-top:-20px">
									...
									<input type="hidden" id="fe_gr_alu" name="fe_gr_alu" value="<?php echo $fe_gr_alu;?>">
