...
$sql = "INSERT INTO planificacion(pensum,cod_mat,lapso,seccion,cod_doc,cupo,tipo,electiva,turno) VALUES ('$pensum','$cod_mat','$lapso','$seccion','$cod_doc','$cupo','$tipo','$electiva','$turno');";
