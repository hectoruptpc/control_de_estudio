...
<script charset="utf-8" src="Formulario_notas_x_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario"><span class=" glyphicon glyphicon-blackboard"></span>Cantidad de alumnos por seccion</label>
                </div>
                <br />
