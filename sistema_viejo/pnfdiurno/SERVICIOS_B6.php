...
<div class="container" id="marco" style="width:400px;margin-top:0px">
	<form class="form-horizontal" id="effect2" method="post" action="TRAMITACION_DE_TITULO.php">
		<fieldset>
			...
			<div class="form-group">
				<div class="col-md-12" style="margin-left: 20px;;margin-top:20px">
					<input type="submit" id="submit" class="btn btn-primary" name="submit" value="Buscar" style="background: #0C4783;width:120px"/> 
