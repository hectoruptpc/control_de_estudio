...
$sql = "INSERT INTO horarios(cod_mat,electiva,lapso,seccion,cod_doc,aula,descrip,hora_de_inicio,hora_final,cantidad,dia) VALUES ('$cod_mat','$electiva','$lapso','$seccion','$cod_doc','$aula','$descrip','$hora_de_inicio','$hora_final','$cantidad','$dia');";
