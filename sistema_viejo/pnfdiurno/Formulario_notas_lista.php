...
<script charset="utf-8" src="Formulario_notas_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario"><span class="glyphicon glyphicon-tasks"></span> Inscribir una materia a un alumno</label>
                </div>
                <br />
...
<table>
        ...
        <td style="width: 120px;">
              <a href="SERVICIOS2b.php" class="btn btn-primary" style="background: #0C4783;width:120px"><span class="glyphicon glyphicon-plus"></span> Agregar</a></td>
