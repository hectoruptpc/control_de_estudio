...
$result = mysqli_query($conn, $sql);
 ...
 /////////****************////////////////         
  $sql = "UPDATE notas SET `cod_mat` = REPLACE(`cod_mat`, '".$cod_mat."', '".$cod_mat2."') WHERE `seccion`='".$seccion."' AND `cod_doc`='".$cod_doc."' AND `lapso`='".$lapso."'";

  $result = $conn->query($sql);

  $sql = "UPDATE agregarseccion SET `cod_mat` = REPLACE(`cod_mat`, '".$cod_mat."', '".$cod_mat2."') WHERE `seccion`='".$seccion."' AND `cod_doc`='".$cod_doc."' AND `lapso`='".$lapso."'";

  $result = $conn->query($sql);
 /////////****************//////////////// 


  $sql = "SELECT notas.codigo,notas.cod_mat,notas.cod_doc,notas.lapso,notas.seccion,alumno.nombre FROM notas,alumno where notas.cod_mat='".$cod_mat2."' and notas.seccion='".$seccion."' and notas.lapso='".$lapso."' and notas.cod_doc='".$cod_doc."' and notas.codigo=alumno.cedula";
