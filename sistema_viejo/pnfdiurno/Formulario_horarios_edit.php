...
require('db.php');
$sql = "UPDATE horarios SET  cod_mat = '$cod_mat' , electiva = '$electiva' , lapso = '$lapso' , seccion = '$seccion' , cod_doc = '$cod_doc' , aula = '$aula' , descrip = '$descrip' , hora_de_inicio = '$hora_de_inicio' , hora_final = '$hora_final' , cantidad = '$cantidad' , dia = '$dia' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_horarios_lista.php">
      <fieldset>
