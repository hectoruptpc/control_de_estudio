...
<body>
	<div class="container" id="marco" style="width:45%">
		<form class="form-horizontal" id="effect2" method="post" action="SERVICIOS_SECCION5_2.php">
			<fieldset>
				<div class="form-group" id="titulo_formulario"> 
					<label id="titulo_formulario"><span class="fa fa-pie-chart"></span> Seleccione el Pensum <span class="badge" style="background:#F0F0F0;color: #0C4783;font-weight:bold">01</span></label>
				</div>
