 ...
 /////////****************////////////////         
            $sql = "UPDATE notas SET `cod_doc` = REPLACE(`cod_doc`, '".$cod_doc."', '".$cod_doc2."') WHERE `cod_mat`='".$cod_mat."' AND `lapso`='".$lapso."' AND `tiplap`='".$tiplap."' AND `cod_doc`='".$cod_doc."' AND `seccion`='".$seccion."'";
 
            $result = $conn->query($sql);

            $sql = "UPDATE agregarseccion SET `cod_doc` = REPLACE(`cod_doc`, '".$cod_doc."', '".$cod_doc2."') WHERE `cod_mat`='".$cod_mat."' AND `lapso`='".$lapso."' AND `tipo`='".$tiplap."' AND `cod_doc`='".$cod_doc."' AND `seccion`='".$seccion."'";
