...
<div class="form-group" id="marco" style="width:500px;">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_electivas_edit.php">
        <fieldset>
            <div class="form-group" id="titulo_formulario">
                <label id="titulo_formulario"><span class="glyphicon glyphicon-pencil"></span> Editar electivas</label>
            </div>
<p>
...
<div class="form-group" style="padding-left: 15px;padding-right:20px">
  <div class="col-md-12" style="width: 100%;margin-left: 0%;margin-top:0px">
    ...
    <input id="cod_ele" name="cod_ele" type="text" placeholder="Cod Ele" class="form-control" value="<?php echo $cod_ele;?>">
  </div>
</div>
