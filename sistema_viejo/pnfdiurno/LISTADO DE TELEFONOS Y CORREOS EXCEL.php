...
$xls->getActiveSheet()->setCellValue('E'.$i, "TELEFONO");
...
$xls->getActiveSheet()->setCellValue('F'.$i, "TELEFONO");
...
$xls->getActiveSheet()->setCellValue('G'.$i, "TELEFONO");
...
$xls->getActiveSheet()->setCellValue('H'.$i, "CORREO");
