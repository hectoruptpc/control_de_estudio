...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_electivas_data.php?job=get_companies",
  	"columns": [
    { "data": "cod_ele"},
    { "data": "descrip2"},
    { "data": "pensum"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la electivas?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_electivas_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_electivas_eliminar.php",{accion: "Borrar", id:valor},function(res){
