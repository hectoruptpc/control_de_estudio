...
<script charset="utf-8" src="Formulario_seccion_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario"><span class="glyphicon glyphicon-list"></span> Formulario de seccion</label>
                </div>
                <br />
...
<table>
        ...
        <td style="width: 120px;">
              <a href="Formulario_seccion_form_agregar.php" class="btn btn-primary" style="background: #0C4783;width:120px"><span class="glyphicon glyphicon-plus"></span> Agregar</a></td>
