...
<body>
 <div class="container" id="marco" style="width:50%">
   <form class="form-horizontal" id="effect2" method="post" action="REPORTE DE CARGA DE NOTAS.php">
    <fieldset>
     <div class="form-group" id="titulo_formulario"> 
      <label id="titulo_formulario"><span class="fa-file-text-o fa"></span> Reporte de Carga de Notas</label>
    </div>
