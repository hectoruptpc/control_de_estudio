...
$pensum=$_POST["pensum2"];
$carrera=substr($_POST["pensum2"], 0, 1);
$lapso=$_POST["lapso2"];
$cod_mat=$_POST["cod_mat2"];        
$cod_doc=$_POST["cod_doc2"];		
...
$sql = "SELECT DISTINCT alumno.cedula,alumno.nombre FROM notas,alumno WHERE notas.seccion='".$seccion."' and notas.cod_mat='".$cod_mat."' and notas.lapso='".$lapso."' and notas.cod_doc='".$cod_doc."' and alumno.cedula=notas.codigo ORDER BY alumno.nombre ASC";
