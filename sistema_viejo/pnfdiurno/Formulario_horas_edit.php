...
$sql = "INSERT INTO horas_auditoria(accion,cod,usuario,hora2,fecha,hora) VALUES ('$accion','$cod','$usuario','$hora2','$fecha','$hora');";
$result = mysqli_query($conn, $sql);

require('db.php');
$sql = "UPDATE horas SET  hora = '$hora' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_horas_lista.php">
      <fieldset>
