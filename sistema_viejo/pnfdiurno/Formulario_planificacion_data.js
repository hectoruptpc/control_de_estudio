...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_planificacion_data.php?job=get_companies",
  	"columns": [
    { "data": "pensum"},
    { "data": "cod_mat"},
    { "data": "descrip2"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la planificacion?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_planificacion_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_planificacion_eliminar.php",{accion: "Borrar", id:valor},function(res){
