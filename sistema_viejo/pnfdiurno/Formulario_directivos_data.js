...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_directivos_data.php?job=get_companies",
  	"columns": [
    { "data": "nombre"},
    { "data": "cargo"},
    { "data": "lugar"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la directivos?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_directivos_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_directivos_eliminar.php",{accion: "Borrar", id:valor},function(res){
