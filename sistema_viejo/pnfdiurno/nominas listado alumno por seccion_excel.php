...
<body>
<div class="form-group" id="marco" style="width:95%">
<form class="form-horizontal" id="effect2" method="post" action="LISTADO DE ALUMNOS SECCION.php">
	<div id="titulo_formulario"> 
		<label id="titulo_formulario"><span class="glyphicon glyphicon-floppy-save"></span> Listado de Alumnos por Seccion</label>
	</div>

	<div class="form-group">
		<div class="col-md-6" style="margin-left: 10px;margin-top:20px;">
		    <input type="submit" class="btn btn-primary" name="submit" value="Exportar a Excel" style="width:180px;margin-left: 15px;"/> 
			<a href="principal.php" class="btn btn-primary" style="width:120px"><span class="glyphicon glyphicon-log-out"></span> Salir</a>
		</div>
	</div>		

	<div class="form-group">
		<div class="col-md-4" style="width: 250px;margin-left: 24px;margin-top:0px">
			<label for="pensum">Pensum</label>    
			<input type="hidden" id="pensum" name="pensum">
			<div class="selector-pensum">   
				<select style="width:250px;height: 38px;margin-top:0px;margin-left: 0px;" required></select>      
			</div> 
		</div>

		<div class="col-md-4" style="width: 250px;margin-left: 10px;margin-top:0px">
		...
		<div class="col-md-4" style="width: 250px;margin-left: 10px;margin-top:0px">
			...
			<div class="selector-lapso">   
				<select style="width:250px;height: 38px;margin-top:0px;margin-left: -30px;" required></select>   
			</div> 
		</div>
		
		<div class="col-md-4" style="width: 250px;margin-left: 10px;">
...
<script>
    ...
    var val1 = $('#pensum').val();
    var val2 = $('#seccion').val();
    var val3 = $('#lapso').val();   
    $.ajax({
    	type: "post",
        url: "buscar13.php",
        data:{pensum:val1,seccion:val2,lapso:val3},
