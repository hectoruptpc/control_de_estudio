...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_horas_data.php?job=get_companies",
  	"columns": [
    { "data": "hora"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_horas_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_horas_eliminar.php",{accion: "Borrar", id:valor},function(res){
