...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_lapso_data.php?job=get_companies",
  	"columns": [
    { "data": "id"},
    { "data": "lapso"},
    { "data": "descrip"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   if (isConfirm){
     ...
     $.post("Formulario_lapso_eliminar.php",{accion: "Borrar", id:valor},function(res){
     ...
     if (res=="registro Borrado"){
       ...
       swal({   title: res,   text: "",   type: "success",   showCancelButton: false,   confirmButtonColor: "#4D759E",   confirmButtonText: "ok",   closeOnConfirm: false }, function(){
                window.location = 'Formulario_lapso_lista.php';
        });
       }
     });
