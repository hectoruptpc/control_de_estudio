...
require('db.php');
$sql = "UPDATE docente SET  cod_doc = '$cod_doc' , cedula = '$cedula' , nombre = '$nombre' , condicion = '$condicion' , depart = '$depart' , sexo = '$sexo' , fechanac = '$fechanac' , titulo_c = '$titulo_c' , titulo_l = '$titulo_l' , tipo = '$tipo' , ingreso = '$ingreso' , categoria = '$categoria' , dedicacion = '$dedicacion' , telefono = '$telefono' , asignatura = '$asignatura' , horas_ad = '$horas_ad' , horas_do = '$horas_do' , observa = '$observa' , actividad = '$actividad' , turno = '$turno' WHERE id ='".$id."'";
