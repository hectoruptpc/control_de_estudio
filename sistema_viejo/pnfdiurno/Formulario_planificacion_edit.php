...
require('db.php');
$sql = "UPDATE planificacion SET  pensum = '$pensum' , cod_mat = '$cod_mat' , lapso = '$lapso' , seccion = '$seccion' , cod_doc = '$cod_doc' , cupo = '$cupo' , tipo = '$tipo' , electiva = '$electiva' , turno = '$turno' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_planificacion_lista.php">
      <fieldset>
