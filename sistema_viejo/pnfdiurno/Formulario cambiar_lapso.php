...
<?php
session_start();                                                  
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['cambiar_lapso']==1) {
} else {
		...
		<form class="form-horizontal" name="informacion" id="effect2" method="post" action="">
			<fieldset>
				<div class="form-group" id="titulo_formulario"> 
					<label id="titulo_formulario"><span class="glyphicon glyphicon-calendar"></span> Cambiar Lapso</label>
				</div>
				...
				<p> 
					...
					<div class="form-group">
						...
						<div class="selector-cod_mat" id="sp5" style="margin-left: 25px;">    
							<select></select>   
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-md-12" style="margin-left: 10px;">
							<label for="lapso">Lapso actual</label>  
					...
					<div class="form-group">
						<div class="col-md-12" style="margin-left: 10px;">
							<label for="lapso2">Lapso nuevo</label>  
							<input type="hidden" id="lapso2" name="lapso2">                   
						</div>

						<div class="selector-lapso2" style="margin-left: 25px;">  
							<select></select>  
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="selector-seccion" id="sp6" style="margin-left: 25px;">  
							<select></select>    
						</div>
					</div> 
