...
$carrera=substr($_POST["carrera"], 0, 1);
...
$sql = "INSERT INTO lapso(lapso,descrip,carrera) VALUES ('$lapso','$descrip','$carrera');";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_lapso_lista.php">
      <fieldset>
