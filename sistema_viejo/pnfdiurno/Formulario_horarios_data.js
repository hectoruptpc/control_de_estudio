...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_horarios_data.php?job=get_companies",
  	"columns": [
    { "data": "cod_mat"},
    { "data": "electiva"},
    { "data": "lapso"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la horarios?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_horarios_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_horarios_eliminar.php",{accion: "Borrar", id:valor},function(res){
