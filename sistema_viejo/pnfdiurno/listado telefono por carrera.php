...
<body>
	<div class="form-group" id="marco">
		<form class="form-horizontal" id="effect2" method="post" action="LISTADO DE TELEFONOS Y CORREOS.php">
			<fieldset>
				<div id="titulo_formulario"> 
					<label id="titulo_formulario"><span class="fa-list-ul fa"></span> Listado de Telefonos por Carrera</label>
				</div>
		...
		<div class="form-group" style="padding-left:15px;padding-right:15px;">
			...
			<form class="form-horizontal" method="post" action="LISTADO DE TELEFONOS Y CORREOS EXCEL.php">		
