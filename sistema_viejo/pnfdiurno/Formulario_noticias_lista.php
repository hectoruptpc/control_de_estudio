...
<script charset="utf-8" src="Formulario_noticias_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario"><span class="fa fa-map-o"></span> Formulario de noticias</label>
                </div>
                <br />
...
<table>
        ...
        <td style="width: 120px;">
              <a href="Formulario_noticias_form_agregar.php" class="btn btn-primary" style="background: #0C4783;width:120px"><span class="glyphicon glyphicon-plus"></span> Agregar</a></td>
