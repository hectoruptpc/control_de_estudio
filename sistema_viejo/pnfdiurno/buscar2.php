...
$sql = "SELECT DISTINCT alumno.cedula,alumno.nombre,alumno.direccion,alumno.telefonoh,alumno.telefonoc,alumno.telefonot,alumno.email,alumno.actividad,notas.seccion FROM notas,alumno,lismat WHERE lismat.pensum='".$pensum."' and notas.codigo=alumno.cedula and notas.carrera='".$carrera."' and notas.seccion='".$seccion."' and notas.lapso='".$lapso."' and notas.cod_mat=lismat.cod_mat and actividad=1 ORDER BY alumno.nombre ASC";
