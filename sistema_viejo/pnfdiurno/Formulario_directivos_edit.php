...
require('db.php');
$sql = "UPDATE directivos SET  nombre = '$nombre' , cargo = '$cargo' , lugar = '$lugar' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_directivos_lista.php">
      <fieldset>
