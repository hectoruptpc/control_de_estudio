...
<div class="container" id="marco" style="width: 400px">
	<form class="form-horizontal" id="effect2" method="post" action="LISTADO DE PER_TODAS.php">
		<fieldset>
			<div class="form-group" id="titulo_formulario">
				<label id="titulo_formulario"><span class="fa fa-wpforms"></span> Listado a Per por carrera</label>
			</div>           
			...
			<p> 
                ...
                <div class="form-group" style="padding-bottom:30px;">
					...
					<div class="selector-grado">   
						<select style="width:82%;height: 38px;margin-top:0px;margin-left: 0px;position: absolute;" required>
