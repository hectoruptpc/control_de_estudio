...
require('db.php');
$sql = "UPDATE noticias SET  titulo = '$titulo' , contenido = '$contenido' , color = '$color' , icono = '$icono' WHERE id ='".$id."'";
...
<body>
  <div class="container" id="marco">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_noticias_lista.php">
      <fieldset>
