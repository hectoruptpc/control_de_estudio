...
<body>
	<div class="form-group" id="marco">
		<form class="form-horizontal" id="effect2" method="post" action="LISTADO DE ALUMNOS CARRERA PDF.php">
			<fieldset>
		...
		<div class="form-group" style="padding-left:15px;padding-right:15px;">
			...
			<form class="form-horizontal" method="post" action="LISTADO DE ALUMNOS CARRERA.php">		
