...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_agregarseccion_data.php?job=get_companies",
  	"columns": [
    { "data": "pensum"},
    { "data": "cod_mat"},
    { "data": "seccion"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la agregarseccion?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_agregarseccion_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_agregarseccion_eliminar.php",{accion: "Borrar", id:valor},function(res){
