...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_auditor_data.php?job=get_companies",
  	"columns": [
    { "data": "cod_usuario"},
    { "data": "ventana"},
    { "data": "accion"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_auditor_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_auditor_eliminar.php",{accion: "Borrar", id:valor},function(res){
