		...
		<form class="form-horizontal" name="informacion" id="effect2" method="post" action="Formulario notas_insertc.php">
			<fieldset>
				<div class="form-group" id="titulo_formulario"> 
					...
					<input id="grado" name="grado" type="hidden" value="<?php echo $grado;?>" />
					...
					<table> 
						<tr>
                            ...
                            <td style="width: 200px;">                                                                          
                                <label id="materia1" style="color:#0C4783;margin-top:-45px;position: absolute;"></label> 
                            </td>
							...
							<td style="width: 70px;">
								<div class="form-group">
									<div class="col-md-12" style="width: 150px;margin-top:0px">
										...
										<input id="codigo1" name="codigo1" type="text" placeholder="Codigo" value="<?php echo $cedula?>" class="form-control" readonly>
									</div>
								</div>
							</td> 
							...
							<td style="width: 80px;">
								<div class="form-group">
									<div class="col-md-12" style="width: 120px;margin-top:0px">
										...
										<input id="acu1" name="acu1" type="text" placeholder="Acu" class="form-control" readonly>
									</div>
								</div>
							</td>
						</tr>
