...
<script charset="utf-8" src="Formulario_pensum_data.js"></script>
	...
	<div class="container" id="marco">
		...
		<fieldset>
			<div class="form-group" id="titulo_formulario">
				<label id="titulo_formulario"><span class="glyphicon glyphicon-equalizer"></span> Formulario de Carraras</label>
			</div>
			<br />
			...
			<table>
				<tr>
					...
					<td style="width: 120px;">
						<a href="Formulario_pensum_form_agregar.php" class="btn btn-primary" style="width:120px"><span class="glyphicon glyphicon-plus"></span> Agregar</a></td>
