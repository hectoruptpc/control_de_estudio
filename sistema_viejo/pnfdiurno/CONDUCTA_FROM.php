...
<body>
 <div class="container" id="marco" style="width:80%">
   <form class="form-horizontal" id="effect2" method="post" action="CONDUCTA.php">
    <fieldset>
     <div class="form-group" id="titulo_formulario"> 
      <label id="titulo_formulario"><span class="glyphicon glyphicon-th-list"></span> CONSTANCIA DE CONDUCTA</label>
    </div>
        ...
        <td>
          <div class="form-group">
            <div class="col-md-12" style="margin-top: 27px;margin-left: 0">                                
              <a type="button" id="btnbuscar2" class="btn btn-primary" style=""><span class="glyphicon glyphicon-search"></span> Buscar</a>             
            </div>
          </div>
        </td>
