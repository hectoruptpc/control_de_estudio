...
<div class="container" id="marco" style="width:600px;">
    <form class="form-horizontal" id="effect2" method="post" action="Formulario_notas2_tabla_index2.php">
        <fieldset>
            <div class="form-group" id="titulo_formulario">
                <label id="titulo_formulario"><span class="glyphicon glyphicon-stats"></span> Cargar notas por seccion</label>
            </div>
            ...
            <div class="form-group" style="padding-left: 20px">
                <div class="col-md-12">
                    ...
                    <input type="submit" class="btn btn-primary" name="submit" value="Buscar" style="width:120px"/> 
