										...
										<td style="width: 100px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px">
													...
													<input type="text" id="cedula"  class="form-control" name="cedula" value="<?php echo $cedula?>" readonly style="background: #FFFFFF;">  												</div>
											</div>
										</td> 
										<td style="width: 10px;"></td> 
										<td style="width: 230px;"> 
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px;margin-left: 0px">
													...
													<input type="text" id="cod_doc" class="form-control" name="cod_doc" style="background: #FFFFFF;" value="<?php echo $cod_doc?>">					
												</div>
												<div class="selector-cod_doc">   
													<select style="width:120px;height: 37px;margin-top:28px" required></select> 
												</div>
											</div>
										</td>
										<td style="width: 10px;"></td> 
										<td style="width: 230px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px;margin-left: 0px">
													...
													<input type="text" id="cod_mat" class="form-control" name="cod_mat" style="background: #FFFFFF;" value="<?php echo $cod_mat?>">					
												</div>
										...
										<td style="width: 230px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px">
													...
													<input type="text" id="electiva" class="form-control" name="electiva" style="background: #FFFFFF;" value="<?php echo $electiva?>">
												</div>
										...
										<td style="width: 230px;"> 
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px;margin-left: 0px">
													...
													<input type="text" id="lapso" class="form-control" name="lapso" style="background: #FFFFFF;" value="<?php echo $lapso?>">					
												</div>
										...
										<td style="width: 230px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px;margin-left: 0px">
													...
													<input type="text" id="seccion" class="form-control" name="seccion" style="background: #FFFFFF;" value="<?php echo $seccion?>">					
												</div>
												<div class="selector-seccion">   
													<select style="width:120px;height: 37px;margin-top:28px;" required>
										...
										<td style="width: 230px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px;margin-left: 0px">
													...
													<input type="text" id="nota" class="form-control" name="nota" style="background: #FFFFFF;" value="<?php echo $nota?>">					
												</div>
										...
										<td style="width: 100px;">
											<div class="form-group">
												<div class="col-md-12" style="width:120px;margin-top:0px">
													...
													<input type="text" id="acu" class="form-control" placeholder="Acu" name="acu" style="background: #FFFFFF;" value="<?php echo $acu?>" readonly>  
												</div>
											</div>
										</td>
