...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_noticias_data.php?job=get_companies",
  	"columns": [
    { "data": "titulo"},
    { "data": "contenido"},
    { "data": "color"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la noticias?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_noticias_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_noticias_eliminar.php",{accion: "Borrar", id:valor},function(res){
