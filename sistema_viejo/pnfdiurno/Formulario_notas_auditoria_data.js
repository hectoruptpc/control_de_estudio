...
$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
  	"ajax": "Formulario_notas_auditoria_data.php?job=get_companies",
  	"columns": [
    { "data": "accion"},
    { "data": "id"},
    { "data": "usuario"},
...
$(document).on('click', '.function_delete a', function(e){
   ...
   {
      swal({
      title: "Desea borrar la notas_auditoria?",
      text: nombre,
      type: "warning",
   ...
   if (isConfirm){
     ...
     window.location = 'Formulario_notas_auditoria_lista.php';

   } else {
     show_loading_message();
     $.post("Formulario_notas_auditoria_eliminar.php",{accion: "Borrar", id:valor},function(res){
