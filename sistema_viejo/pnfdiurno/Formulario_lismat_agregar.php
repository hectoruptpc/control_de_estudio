...
$sql = "INSERT INTO lismat(pensum,cod_mat,descrip2,creditos,aprobatori,semestre,trayecto,divicion,nota,cod_mat_libro_rector,cod_mat_ant) VALUES ('$pensum','$cod_mat','$descrip2','$creditos','$aprobatori','$semestre','$trayecto','$divicion','$nota','$cod_mat_libro_rector','$cod_mat_ant');";
