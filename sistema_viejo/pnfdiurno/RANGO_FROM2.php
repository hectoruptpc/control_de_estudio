...
<body>
 <div class="container" id="marco" style="width:80%">
   <form class="form-horizontal" id="effect2" method="post" action="RANGO2.php">
    <fieldset>
     <div class="form-group" id="titulo_formulario"> 
      <label id="titulo_formulario"><span class="glyphicon glyphicon-th-list"></span> CONSTANCIA DE UBICACIÓN Y RANGO</label>
    </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    function enviar_datos(){
      ...
      $.ajax({
        type: "post",
        url: "buscar_ubicacion_y_rango2.php",
        data:{buscar:valor},
