...
<script charset="utf-8" src="Formulario_inscribir_materia_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario">Formulario de Inscribir Materia</label>
                </div>
                <br />
...
<table>
        ...
        <div class="lightbox_container" style="width: 70%;height:80%;">
          ...
          <div class="lightbox_content">
           ...
           <h2>Agregar Inscribir Materia</h2>
           <form class="form add" id="form_inscribir_materia" data-id="">
              <div class="input_container">
                <label for="codigo">Codigo:</label>
                <div class="field_container">
                  <input type="text" class="text" name="codigo" id="codigo" tabindex="1" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="cod_mat" id="cod_mat" tabindex="2" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="descrip2" id="descrip2" tabindex="3" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="tiplap" id="tiplap" tabindex="5" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="nota" id="nota" tabindex="6" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="acu" id="acu" tabindex="7" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="cod_doc" id="cod_doc" tabindex="8" required>
              </div>
          </div>
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="text" class="text" name="seccion" id="seccion" tabindex="9" required>
              </div>
          </div>
