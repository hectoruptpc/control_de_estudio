...
require('db.php');
$sql = "UPDATE alumno SET  cedula = '$cedula' , nombre = '$nombre' , carrera = '$carrera' , mencion = '$mencion' , plan = '$plan' , actividad = '$actividad' , sexo = '$sexo' , edocivil = '$edocivil' , fechanac = '$fechanac' , edad = '$edad' , direccion = '$direccion' , telefonoh = '$telefonoh' , telefonoc = '$telefonoc' , telefonot = '$telefonot' , email = '$email' , ingreso = '$ingreso' , turno = '$turno' WHERE id ='".$id."'";
