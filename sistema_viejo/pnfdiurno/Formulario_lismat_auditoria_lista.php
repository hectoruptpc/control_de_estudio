...
<script charset="utf-8" src="Formulario_lismat_auditoria_data.js"></script>
...
<div class="container" id="marco">
            ...
            <fieldset>
                <div class="form-group" id="titulo_formulario">
                    <label id="titulo_formulario">Formulario de lismat_auditoria</label>
                </div>
                <br />
