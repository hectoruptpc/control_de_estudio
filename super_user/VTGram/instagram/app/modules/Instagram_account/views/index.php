<div class="wrap">
	<div class="section-dashboard">
		<form class="formList">
            <div class="tab-head">
				<span class="title"> <i class="fa fa-instagram text-info" aria-hidden="true"></i> <?=l('account-manage')?></span>
				<div class="right">
			...
			<div class="table-responsive mt15">
	            <table class="table table-bordered table table-striped">
	                <tbody><tr>
	                    ...
	                    <th><?=l('username')?></th>
	                    <th style="width: 130px"><?=l("Reconnect")?></th>
	                ...
	                <tr class="item" data-id="<?=$row->id?>">
	                    ...
	                    <td><?=$row->username?></td>
	                    <td><a href="javascript:void(0);" class="btn btn-primary btnUpdateGroups" data-type="page"  data-id="<?=$row->id?>"><?=l("Reconnect")?></a></td>
