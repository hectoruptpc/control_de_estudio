<div class="wrap">
	<div class="section-schedule">
		<div class="tab-head">
			<span class="title"> <i class="fa fa-commenting text-danger" aria-hidden="true"></i> <?=l('Auto Comment')?></span>
			<div class="right">
				...
				<a href="<?=PATH."instagram/follow/log?type=comment"?>" class="btn btn-danger btn-flat"><i class="fa fa-history" aria-hidden="true"></i> <?=l('History')?></a>
				<div class="btn-group">
			        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><?=l('action')?>
			            <span class="fa fa-caret-down"></span></button>
			        <ul class="dropdown-menu">
			            <li><a class="btnActionList" data-action="repost" data-type="comment" href="javascript:void(0);"><?=l('Start All')?></a></li>
			            <li><a class="btnActionList" data-action="cancel" data-type="comment" href="javascript:void(0);"><?=l('Stop All')?></a></li>
			            <li><a class="btnActionList" data-action="delete" data-type="comment" href="javascript:void(0);"><?=l('Delete All')?></a></li>
			        </ul>
			    </div>
			</div>
		</div>
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="row">
					...
					<div class="list_load" data-page="0" data-action="<?=PATH."Instagram_follow/ajax_comment_page"?>"></div>
					<?php }else{?>
					<div class="col-md-12">
							    ...
							    <div class="row">
							    	<div class="form-group col-md-12 mb0">
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" checked="true" name="type" value="1"> <span style="margin-right: 20px;">&nbsp;&nbsp;<i class="fa fa-hashtag" aria-hidden="true"></i> <?=l('Comment by hashtags')?></span>
					                    </span>
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" name="type" value="2"> <span style="margin-right: 20px;">&nbsp;&nbsp;<i class="fa fa-map-marker" aria-hidden="true"></i> <?=l('Comment by location')?></span>
					                    </span>
					                    <span style="display: inline-block; margin-bottom: 5px;">
					                    	<input type="radio" class="input-icheck check-type-follow" name="type" value="3"> &nbsp;&nbsp;<i class="fa fa-user" aria-hidden="true"></i> <?=l('Comment by username')?>
					                    </span>
					                </div>
								    <div class="form-group col-md-12">
