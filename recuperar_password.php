...
<footer class="bg-dark text-white py-4 mt-5">
    <div class="container-fluid text-center">
        <p class="mb-2">
            Potenciado por la <a href="<?php echo $sitio_cyt; ?>" target="_blank" rel="noopener noreferrer" class="text-info font-weight-bold">Unidad de Ciencia y Tecnología de la <?php echo $siglas_institucion; ?></a>
        </p>
        <p class="mb-1 small text-light">
            &copy; <?php echo date('Y'); ?> <?php echo $nombre_empresa; ?>. Reservados Todos los Derechos.
        </p>
