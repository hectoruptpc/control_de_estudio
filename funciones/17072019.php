...
session_start();
    ...
    $logo_web = '<img src="https://local.jesuministrosymas.com.ve/image/LOGO.png" width="180" height="30">';
...
<!--
    ...
    <link rel="icon" type="image/png" href="../images/128x128image.png">

    <link rel="icon" type="image/png" href="../images/200x200image.png">
-->
    ...
    <script src="../funciones/js/summernote-ES.js"></script>

    <script src="../funciones/js/push.js"></script>

    <script src="../funciones/js/push.min.js"></script>

    <meta name="google-site-verification" content="shROdyzBVqSwjPZum4CStx3DIztqLVR0bAOpxbihTK4" />

    <script src="../funciones/js/stacktable/stacktable.js"></script>
    <link href="../funciones/js/stacktable/stacktable.css" rel="stylesheet">
  ...
  <script type="text/javascript" charset="utf8" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.0/jquery.js"></script>
  ...
  <script src="../funciones/js/kernel.js"></script>
  ';
...
$image_responsive = '<img src="https://lh3.googleusercontent.com/Ghjo1TDm9dPi5Mn4_u58wgZjh5cUMF72Fq69fVv3QTqpDZPY_0o-vccHj1QBO3yUc-GNN6oNeHgxHG1ye-ytnnOIkHl8CYv6I3PZ6PiI-j1OQ86Gcej0BAL4Le5ur2VjyJq8UIyaG-aesjorrcqktf6afmcKL8X3k28tHDPo2c2vl7DZDMINyEdinHQ6y67JzWWQYdeIA87qJkcRsgcQYFFWpH9iwBmqlzO4e0RKtNqZViPzuy902oErEuWooyXUsKhEIA3di6plHEama3QrO-pGZDknfvK_DSk4PAIsiYhXeQ6kS_4JxqxatyB961nG5i_iucUjB8BKdMUC_M7ZCrCi8a5t6lj3eEa4IicYkqAIclphx_S9k_SD_bkGOGIYvCleSO_IWB8IZpteKBjGWQoTGZaMpw73vknWzbziPeJUh3kfnnftk8vcG__CokZ9RVFoM1091Ai51B_IC1pAr4Ih6JGbslIMKeaI89JtNCv2OS8S2EPlZUhrNodgqVLaUVuYkgkQCQpPHqS7VxmFqxAkiRKvWU4kk3u_QoqbR7Xejp6fzbb_fUSJSg-DY6hrjbD_HFKrzqGg1HsXvY46mPmeGPkUnhL4jLn94pqZxZWswHnQffLAqrq691tLS0l4FLM0lZkV7IwCITwBpmuqsJHygrzy2eJ6=w622-h312-no" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';

$logo_operadoras_center = '  <div class="text-center">
    <img src="./images/operadoras/movilnet.png" class="img-thumbnail" alt="Movilnet" width="50" >
    <img src="./images/operadoras/movistar.png" class="img-thumbnail" alt="Movistar" width="50" >
    <img src="./images/operadoras/digitel.png" class="img-thumbnail" alt="Digitel" width="50" >
    <img src="./images/operadoras/directv.png" class="img-thumbnail" alt="Directv" width="50" >
    <img src="./images/operadoras/inter.png" class="img-thumbnail" alt="Inter" width="50" >
  </div>';
...
@$usua = $_SESSION['user']['username'];
  ...
  $logo_movistar = '<img src="../images/operadoras/movistar.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
  $logo_digitel = '<img src="../images/operadoras/digitel.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
  $logo_directv = '<img src="../images/operadoras/directv.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
  $logo_inter = '<img src="../images/operadoras/inter.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
...
$ip = get_client_ip();
    ...
    function validar_monto_recarga($a){
      ...
      global $db, $operador, $multiplo, $porcentaje, $monto_minimo, $bootstrap_head, $bootstrap_footer;

      selector_operador();

      $query = "SELECT monto FROM `monto_recarga` WHERE mod (monto, '$multiplo') = 0 AND monto >= $monto_minimo AND monto = $a ORDER BY monto ASC";
...
function monto_recarga(){
	global $db, $operador, $multiplo, $monto_minimo;

selector_operador();


	$query = "SELECT * FROM `monto_recarga` WHERE mod (monto, '$multiplo') = 0 AND monto >= $monto_minimo ORDER BY monto ASC";
	$results = mysqli_query($db, $query);
...
selector_operador();
	...
	$query = "SELECT * FROM `monto_recarga` WHERE mod (monto, '$multiplo') = 0";
	$results = mysqli_query($db, $query);
	while ($valores = mysqli_fetch_array($results)) {
...
$cuerpo = 'Hola Usuario '.$nombre.' <br><br>Usted ha creado su contraseña de manera exitosa.<br><p style="text-align: justify;"><br>Podra ingresar utilizando como usuario sus credenciales de acceso, puede utilizar su correo electronico o su numero de usuario</p> <p style="text-align: justify;"><strong>CREDENCIALES DE ACCESO:</strong></p><p style="text-align: center;"><br>  <span style="background-color: #70FF70; color: #000000; display: inline-block; padding: 3px 10px; font-weight: bold; border-radius: 5px;">Correo Registrado: <b>'.$email.'</b><br>Su Usuario es: <b>'.$username.'<b><br>Su clave de acceso es: <b>'.$password_1.'</b></span></p><br><br> Recomendamos que no borre este correo y copie sus datos de acceso en un lugar seguro.<br> <br> <br><b>PREGUNTAS FRECUENTES</b><p></p><p><b>¿Cuales son los montos de inversión?</b></p><p></p><ul><li>Primero usted debe pagar la mensualidad por uso de la plataforma. <a href="https://virtual.jesuministrosymas.com.ve/u/usuario/mensualidad_movilnet.php"> <b>MENSUALIDADES</b></a></li><li>Y luego efectuar el pago de su orden de tarjetas según el monto permitido por cada plan de suscripción. <a href="https://virtual.jesuministrosymas.com.ve/u/usuario/pedidos_movilnet.php"> <b>PEDIDOS</b></a></li></ul> <b>Solamente podrá hacer una solicitud por orden y no puede generar otra solicitud mientras tenga una orden en proceso.</b> <p></p><p><b>¿De que denominación recibiré las Tarjetas?</b></p><p>Usted recibirá el monto solicitado en su pedido en el equivalente exacto de tarjetas con valores únicos o combinados, esta variable no la controlamos nosotros si no la operadora <b>CANTV-MOVILNET</b> es decir si usted va a recibir (50000 Bs.) en tarjetas UN1CA usted puede recibir cualquier combinación posible que sume ese valor es decir:</p><p></p><ul><li>50 Unidades de tarjetas de (1000 Bs.).</li> <li>25 Unidades de tarjetas de (2000 Bs.).</li> <li>5 Unidades de tarjetas de (5000 Bs.) y 25 Unidades de tarjetas de (1000 Bs.).</li> </ul> Tome en cuenta que podra recibir cualquier combinación que sume la cantidad de saldo a recibir. <b>Lo mismo sucede si el monto a solicitar es 10000 Bs., 20000 Bs., 30000 Bs., 40000 Bs., etc etc..!</b> Usted recibirá esa cantidad de dinero en tarjetas según las denominaciones disponibles por la operadora, normalmente esta variable se va adaptando con el tiempo a los nuevos valores de los planes de telefonía por tal motivo las denominaciones de las tarjetas se van adaptando con el tiempo.<p></p><p><b>¿A que cuenta debo efectuar mi pago?</b></p><p>Usted debe hacer su pago a cualquiera de nuestras cuentas indicadas en <b><a href="http://www.jesuministrosymas.com.ve/pagos#TOC-PAGOS-BANCARIOS-EN-VENEZUELA"> FORMAS DE PAGO AQUI</a>.</b></p><p><b>¿A que precio puedo vender las tarjetas?</b></p><p>Usted puede vender las tarjetas al precio que usted considere. Siendo justificado ese extra por el servicio de Impresión y plastificación de las tarjetas, activación on line y cualquier otro servicio que usted considere que puede ofrecer a sus clientes como planificación de recargas semanales o mensuales, recordatorios de recarga, etc. La plastificación de las tarjetas las pueden hacer con cinta adhesiva de la ancha con la finalidad de que no se dañe la impresión si se manipula con las manos húmedas.</p><p><b>¿Es obligatorio Imprimir y Plastificar las tarjetas?</b></p><p>No, no es obligatorio, de hecho muchos usuarios transcriben los códigos en pedazos de papel porque no tienen impresora e igual comercializan sus tarjetas.</p><p><b>¿En que tiempo entregan de las tarjetas una vez efectuado el pago?</b></p><p>Según el Plan seleccionado usted puede recibir sus tarjetas entre 2 y 7 días hábiles, tome en cuenta que la activación de los códigos depende exclusivamente de la operadora CANTV-MOVILNET y lamentablemente la plataforma de ellos falla mucho, y pueden existir retrasos en las entregas de sus pedidos de tarjetas UN1CA. Normalmente los pedidos no tardan mas de 2 días en ser entregados.</p><p><b>¿Trabajan Fines de Semana?</b><br></p><p>No, nuestro horario de atención al publico es de Lunes a Viernes en horario de oficina, no atendemos despachos al mayor los Fines de Semana ni días Feriados. A la plataforma digital usted puede ingresar en cualquier momento desde cualquier dispositivo que posea INTERNET.</p><p><br> <b>¿Como mi cliente activa una tarjeta?</b></p><ul><li>Su cliente podrá activar una tarjeta llamando al servicio de recargas de <b>MOVILNET </b>*21 y seguir los pasos que le indique la operadora o </li><li>Directamente Marcar *21 + código secreto + tecla llamar.</li></ul><p>Para mas detalles de activación de una tarjeta <b>UNICA </b>en otros servicios puede ingresar y ver la información de <a href="http://www.movilnet.com.ve/sitio/minisitios/tarjetaunica/como_usar.html" style="background-color: rgb(255, 255, 255); font-size: 1rem;"><b> COMO USAR TARJETAS UNICA</b></a></p><p><b>¿Puedo efectuar la recargas a mis clientes desde alguna plataforma On-line?</b><br></p><p>Si, si puede hacerlo, es habitual que el servicio de recarga *21 como habitualmente se efectuan las recargas desde celulares MOVILNET se vea colapsado o temporalmente fuera de servicio, entonces hay una alternativa de utilizar el modulo de Recargas On-Line de Movilnet: <a href="http://www.movilnet.com.ve/conweb/recarga_popup.jsp"><b> RECARGAR MOVILNET</b></a></p>';
...
echo '<td>'.$rowid.'</td>
     <td>'.$fecha_mensaje.'</td>
     <td>'.$asunto.'<br><b>'.$destinatario.'</b></td>
     <td>'.$contenido .'</td>
     <td>'.$accion.'</td>
    </tr>';
    }
...
// 2019-07-06 12:38:35
  ...
  if ($rowcont == 0){
    ...
    $contador_msn = 'Hay '.$rowcont .' mensaje por leer!';
  }
  else if ($rowcont > 1) {

    $contador_msn_badge = $rowcont;
    $contador_msn = 'Hay '.$rowcont .' mensajes por leer!';
  }
...
function verificar_transferencias($a){
  ...
  mysqli_close($db);
	...
	// GENERAR PEDIDO
	function pedido(){
    global $db, $usua, $logo, $footer_correo;
	...
	$verf = "SELECT nro_transf FROM pedidos WHERE (nro_transf LIKE '%$numerocorto')";
	$result = mysqli_query($db, $verf);
    $rows =  mysqli_num_rows($result);

    $verf2 = "SELECT nro_transf FROM pagos WHERE (nro_transf LIKE '%$numerocorto')";
    $result2 = mysqli_query($db, $verf2);
    $rows2 =  mysqli_num_rows($result2);
...
$query = "INSERT INTO pedidos (id, usuario, operador, monto, nro_transf, banco_emisor, banco_destino, fecha_transf, ci_nro_cuenta, status_pedido, sin_plan)
VALUES(null, '$usua', '$operador', '$monto', '$nro_transf', '$banco_emisor', '$banco_destino', '$fecha_transf', '$ci_nro_cuenta', '$status_pedido', '$sin_plan')";
	//mysqli_query($db, $query);
...
if (mysqli_query($db, $sql)){
  ...
  $_SESSION['msn_pedidos']  = '<i class="fa fa-exclamation-triangle"></i>Algo ha ocurrido, intente efectuar su declaracion nuevamente.';
    ...
    $monto = number_format($monto, 2, ',', '.');
		...
		$cuerpo = "Hola $nombre <br><br>Pedido Control: <b>$control_id_pedido</b><br>Usted ha registrado un pago por un monto de: $monto Bs. <br>Desde el banco: $banco_emisor <br>Hacia nuestra cuenta en el: $banco_destino <br>
...
function generar_pago_mensualidad(){
	global $db, $mes_de_pago_actual, $logo;
  ...
  //$usua = ($_SESSION['user']['username']);
	...
	$numerocorto = substr($nro_transf, -6);
	$verf = "SELECT nro_transf FROM pagos WHERE (nro_transf LIKE '%$numerocorto')";
	$result = mysqli_query($db, $verf);
  $rows =  mysqli_num_rows($result);

  $verf2 = "SELECT nro_transf FROM pedidos WHERE (nro_transf LIKE '%$numerocorto')";
  $result2 = mysqli_query($db, $verf2);
  $rows2 =  mysqli_num_rows($result2);
...
$query = "INSERT INTO pagos (id, user, monto, a_favor, concepto, mes_de_pago, afiliacion, banco_origen, banco_destino, nro_transf, ci_nro_cuenta, fecha_transf, status_pago) VALUES (null, '$usua', '$monto_mensualidad', '$monto_favor', '$concepto', '$mes_de_pago_actual', '$afiliacion', '$banco_emisor', '$banco_destino', '$nro_transf', '$ci_nro_cuenta', '$fecha_transf', '$status_pago')";
    ...
    if (mysqli_query($db, $query)){
      ...
      if ($monto_favor>0) {
        ...
        if (mysqli_query($db, $sql2)) {
          ...
          $_SESSION['pago_mensualidad']  .= 'Algo ha ocurrido: '.mysqli_error($db);
        }
	...
	$cuerpo = "Hola $nombre: <br><br>Usted ha registrado un pago de manera exitosa por concepto de mensualidad del mes de $mes_de_pago_actual para uso de la plataforma digital de adquisiscion de tarjetas UN1CAS de MOVILNET <br> Su transferencia fue por un monto de $monto_mensualidad Bs. Correspondiente a un Plan $afiliacion <br><br>Esta Transfefencia usted la efectuo: <br> Desde el Banco $banco_emisor <br> Hacia nuestra cuenta en el $banco_destino <br><br>Bajo el Numero de Operacion o Transferencia Bancaria: $nro_transf <br><br>Usted indico que efectuo dicha transferencia en fecha $fecha_transf<br>";
...
$pendiente_pedido = "";
	...
	function contar_pedidos(){
        ...
        $pendiente_pedido, $mes_de_pago_actual;
        if (isAdmin())
        {
//echo 'ADMIN';
...
$contar_pedido .= $entregadomesmonto .' Bs. Entregado en el Mes <br>';
...
function botonera_recarga($a){
  global $db, $usua, $accion, $concepto, $operador, $link, $multiplo, $num_min, $text_num_min, $ph, $nro, $op, $opciones, $monto_minimo, $titulopag, $porcentaje;
...
$boton_editar2 .= '<!-- Modal -->
	...
	$query2 = "SELECT * FROM `monto_recarga` WHERE mod (monto, '$multiplo') = 0 AND monto >= $monto_minimo ORDER BY monto ASC";
...
//LISTA PEDIDOS OPERADOR
//SE ANALIZA Y MUESTRA EN TIEMPO REAL LAS SOLICITUDES DE PEDIDOS DE RECARGA
//SE CALCULA EN TIEMPO REAL EL MONTO A PAGAR Y DA ACCESO AL BOTON PAGAR PEDIDO
function lista_pedidos_operador(){
    global $db, $usua, $operador, $concepto, $link, $accion, $fecha_act, $mens_monto_favor, $monto_favor;
selector_operador();
a_favor();
    $limit_end = 50;
  ...
  $count="SELECT COUNT(*) FROM recargar WHERE user = '$usua' AND operador = '$operador' AND status = '1' AND sin_plan='0'";

  $query = "SELECT * FROM recargar  WHERE user = '$usua' AND operador = '$operador' AND status = '1' AND sin_plan='0' ORDER BY id DESC LIMIT $init, $limit_end";

  $result = mysqli_query($db, $query);
  $row =  mysqli_num_rows($result);

  $mensaje  = '<i class="fa fa-exclamation-triangle"></i> En este momento no hay generadas nuevas ordenes de recargas <b>' .$operador . '</b>';
...
echo "<h2>Lista de Numeros a Recargar</h2>";
    pag($ini, $limit_end, $total);
echo $mens_monto_favor;
    echo '<table id="tabla1" class="table table-bordered table-hover ">
    <thead>
     ...
     <th>ID</th>
      ...
      <th>Tipo de Recarga y Numero</th>
      <th>Monto</th>
     ...
     while($row = $c->fetch_array(MYSQLI_ASSOC))
      ...
      $tipo              = $row['tipo'];
      $monto              = $row['monto'];
      //$monto = $monto - $monto_favor;
      $t = $t + $monto;
      $t = $t - $monto_favor;
      $monto_f = number_format($monto, 2, ',', '.');
      $t_f = number_format($t, 2, ',', '.');
      botonera_recarga($id);

echo '<tr>';
echo '<td>'.base64_encode($id).'</td>
     ...
     echo '<td><b>'.$t_f.' Bs.</b></td>';
     echo '<td><!-- GENERAR PAGO -->
     <span class="d-inline-block" data-toggle="popover" data-content="Aca podrá efectuar el pago del lote de recargas, al dia se efectuaran 2 cortes uno a las 12:30 pm y otro a las 05:00 pm."><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#generarPedido"><i class="fa fa-cart-arrow-down"></i>  Pagar Recargas </button></span><!-- FIN GENERAR PAGO --></td>';
     echo '</tr>';
     echo '</tbody></table>';
...
<div class="modal fade" id="generarPedido" tabindex="-1" role="dialog" aria-labelledby="generarPedidoLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="generarPedidoLabel">Pagar</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
echo ' Si desea conocer nuestras cuentas bancarias donde puede efectuar sus pagos puede ingresar en <a target="_blank" href="http://www.jesuministrosymas.com.ve/pagos#TOC-PAGOS-BANCARIOS-EN-VENEZUELA">VER CUENTAS BANCARIAS PARA PAGOS EN VENEZUELA</a>';
echo '<hr>';
echo 'Debe pagar <b>'.$t_f .' Bs.</b> Para el Operador <b>' .$operador.'</b>';

echo '<hr>';
echo ' <form autocomplete="off" class="was-validated" method="post" action= "">';

echo '<input type="hidden" name="monto" value="'.$t.'">
...
//ACA SE ANALIZARA LA LISTA DE PAGOS FILTRADO POR OPERADORES
//MEDIANTE MENU DESPLEGABLE DEBE MOSTRAR NUMEROS DE TLF A SER RECARGADOS POR CADA SOLICITUD DE RECARGA
//MOSTRAR STATUS DE CADA NUMERO EN ESPERA Y CHEKING PARA INDICAR QUE YA FUE RECARGADO
function lista_status_pedidos_operador(){
    global $db, $usua, $operador, $concepto, $link, $accion, $fecha_act;
...
selector_operador();
  ...
  $count="SELECT COUNT(*) FROM pedidos WHERE usuario = '$usua' AND operador = '$operador' ";

  $query = "SELECT * FROM pedidos  WHERE usuario = '$usua' AND operador = '$operador'  ORDER BY id DESC LIMIT $init, $limit_end";
  ...
  $mensaje  = '<i class="fa fa-exclamation-triangle"></i> En este momento no ha efectuado pagos de Pedidos de Recargas <b>' .$operador . '</b>';
  ...
  if (!$row){
    ...
    $x = $num->fetch_array();
    $total = ceil($x[0]/$limit_end);
    echo '<h2 class ="mt-5">Status de Recargas Solicitadas</h2>';
    echo "<hr>";
    ...
    echo '<div class="accordion" id="accordionExample">';
     ...
     while($row = $c->fetch_array(MYSQLI_ASSOC))
      ...
      $id_code = base64_encode($id);
      $status = $row['status_pedido'];

      if ($status == 'ESPERANDO'){
          $status = '<span class="badge badge-warning"><i class="fa fa-clock"></i> ESPERANDO</span>';
      }

      if ($status == 'APROBADO'){
        $status = '<span class="badge badge-primary"><i class="fa fa-clock"></i> APROBADO ESPERANDO RECARGAS</span>';
    }

    if ($status == 'ENTREGADO'){
        $status = '<span class="badge badge-success"><i class="fa fa-check-circle"></i> RECARGAS EXITOSAS</span>';
    }

    if ($status == 'RECHAZADO'){
        $status = '<span class="badge badge-danger" ><i class="fa fa-check-circle"></i> PAGO RECHAZADO</span>';
    }

      $query2 = "SELECT * FROM recargar WHERE relacion = '$id' ORDER BY id DESC";
      ...
      <div class="card">
        <div class="card-header" id="headingOne'.$id.'">
          <h5 class="row mb-0">
            <button class="btn btn-link collapsed col-12" type="button" data-toggle="collapse" data-target="#collapseOne'.$id.'" aria-expanded="true" aria-controls="collapseOne'.$id.'">

            <div class="row no-gutters">
            <div class="d-flex justify-content-start col-sm-8">Solicitud # '. base64_encode($id).' de Fecha '.$fecha_solicitud  . ' Por un Monto de '.number_format($monto,2,',','.').' Bs.</div>
            <div class="d-flex justify-content-end col-sm-4">'.$status.'
          </div>
        ...
        <div id="collapseOne'.$id.'" class="collapse" aria-labelledby="headingOne'.$id.'" data-parent="#accordionExample">
          <div class="card-body">';
          // CONTENIDO DEL ACORDEON
$a .= "<p>".$motivo."</p>";
          $a .= '<table id="tabla1" class="table table-bordered table-hover table-sm ">
<thead>
<tr>
<th>#</th>
<th>Tipo</th>
...
$tipo = $row2['tipo'] ;
$numero = $row2['nro'] ;
$monto = number_format($row2['monto'],2,',','.');
$status = $row2['status'] ;
...
if ($status == 4){
  $confirmacion = $row2['confirmacion'] ;
    $boton_status = '<div data-html="true" class= "mx-auto btn btn-sm btn-outline-danger" data-toggle="popover" title="Algo Ha ocurrido" data-content="Algo ha ocurrido con la recarga del Numero <br> <b>'.$numero.'</b> aun no ha sido recargado, esperamos puedas solventar el inconveniente con esta recarga.">
<i class="fa fa-clock"></i>
</div> Respuesta de Operadora:  '.$confirmacion;
    //$status = "Esperado ser Recargado";
    $status = $boton_status;
}

if ($status == 1){
    $boton_status = '<div data-html="true" class= "mx-auto btn btn-sm btn-outline-danger" data-toggle="popover" title="Algo ha ocurrido, es posible que tengas que efectuar la declaracion de pago nuevamente.">
...
function enviar_msn(){
  ...
  $asunto2 = "Tiene un Nuevo Mensaje $asunto";
...
function rechazar_pagos(){
  ...
  if ($a == 'mensualidad') {
    ...
    $resumen = 'Por un Monto de: '.$monto . ' Bs. <br> Desde el Banco: '.
...
function suma_mensualidad(){
  global $db, $usua, $pendiente_mensualidad, $suma_mensualidad,$mes_de_pago_actual, $titulopag;
  if (isAdmin()) {
    // SI ES ADMIN
    //$sql="SELECT sum(monto) as total FROM pagos ";
    $sql="SELECT SUM(monto) AS 'total',
    ...
    while ($row = mysqli_fetch_assoc($result))
  {
    ...
    $suma_mensualidad = "Total General ".$row['monto_aprobado_general']." Bs.<br>";
    $suma_mensualidad .= "<b>En el Mes " . $mes_de_pago_actual ."<br> </b>" ;
    $suma_mensualidad .=  "Total " . $row['mes']."<br>";
    $suma_mensualidad .= "Aprobados " .$row['aprobado']."<br>";
    $suma_mensualidad .= "Pendientes " .$row['pendiente']."<br>";
    $suma_mensualidad .= "Basico " .$row['cantidad_basico']. " = ".$row['monto_basico']." Bs.<br>";
    $suma_mensualidad .= "Avanzado " .$row['cantidad_avanzado']. " = ".$row['monto_avanzado']." Bs.<br>";
    $suma_mensualidad .= "VIP " .$row['cantidad_vip']. " = ".$row['monto_vip']." Bs.<br>";
    $suma_mensualidad .= "Movistar " .$row['cantidad_movistar']. " = ".$row['monto_movistar']." Bs.<br>";
    $suma_mensualidad .= "Digitel " .$row['cantidad_digitel']. " = ".$row['monto_digitel']." Bs.<br>";
    $suma_mensualidad .= "Directv " .$row['cantidad_directv']. " = ".$row['monto_directv']." Bs.<br>";
    $suma_mensualidad .= "Inter " .$row['cantidad_inter']. " = ".$row['monto_inter']." Bs.<br>";
...
function pago_mensualidad(){
  ...
  function analisis_dias_restantes(){
    global $db, $usua, $mmo, $concepto, $operador, $link, $m_dias_r, $fecha_sistema, $como_pagar;
...
//PARA EL MODAL DE PAGO DE MENSUALIDAD MOVISTAR
...
if ($status_usuario==0){
  ...
  $motivo = 'No se ha definido un motivo en particular, normalmente este tipo de bloqueo responde al hecho de que nunca ha utilizado la plataforma y el sistema le ha bloqueado como parte de un proceso de depuración de nuestro sistema.';
...
function selector_bancario($a){
  ...
  if ($a == 'Banco Banesco a Nombre de JE SUMINISTROS Y MAS CA'){
    ...
    if ($a == 'PAYPAL - GIFT CARD (SOLO MENSUALIDADES)'){
    $dest = 'PAYPAL - GIFT CARD';
    }
    return $dest;
}
...
$img_ope="";
function img_ope($a){
  global $img_ope, $logo_movilnet, $logo_movistar, $logo_digitel, $logo_directv, $logo_inter;
...
// SI ES ADMIN
    ...
    <thead>
     ...
     <th>Usuario / Nombre / Tlf</th>
      <th>Fecha de Transf </th>
      <th>Monto / Mes Pagado / Concepto</th>
      <th>Nro Transf / CI</th>
      <th>Desde / Hasta</th>
      <th>Accion</th>
     </tr>
...
echo '<td>'.$rowid.'</td>
       ...
       <td>'.$rowmes['monto'].' Bs. <br> '.$rowmes['mes_de_pago']. '<br>'.$concep.'</td>
       <td>'.$rowmes['nro_transf'] . ' / '.$rowmes['ci_nro_cuenta'].'</td>
...
if (mysqli_query($db, $query)) {
    ...
    $recarga = '<table class="table table-bordered table-hover ">';
    $recarga .= '<thead><tr>';
...
$cuerpo = "Hola $nombre <br><br> <h1>FAVOR LEER</h1>Por medio de la presente le informamos que ya la operadora Movilnet ha asignado tarjetas UN1CAS a su Pedido y desde ya puede acceder y ver su Pedido de Tarjetas On-Line en: ";
...
$a = '
     <div class="card">
      ...
      <div class="row no-gutters">
           <div class="d-flex justify-content-start col-sm-8">'.$rowid.' Seccion: '. $seccion.'.</div>
...
if (!$rows){
  ...
  $mensaje  = 'No hay contenido que Mostrar';
 ...
 $boton_contratar = '<a href="mensualidad_movilnet.php" class="btn btn-sm btn-outline-success"><span class="d-inline-block" data-toggle="popover" data-content="Aca podra ir a la web de Mensualidades Movilnet donde podra contratar el plan de su preferencia."><i class="fa fa-shopping-cart"></i><b> Contratar</b></span></a>';
  ...
  <div class="col-sm-12 col-md-4 card" style="background-color: #e3f2fd;">
    ...
    <i class="fas fa-fw fa-user"></i>
      ...
      <li>Este es un plan destinado a usuarios domesticos, para su consumo o el consumo familiar.</li>
        ...
        <li>Tiempo de espera entre 3 y 4 dias. El tiempo de espera dependerá de la disponibilidad de la operadora y de la posición en la cola virtual de despacho.</li><li>
  ...
  <i class="fas fa-fw fa-user-cog"></i>
    ...
    <li>Este es un plan destinado a negocios con ventas mas altas, ejemplo: Farmacias, Agencias de Loterias, Kioscos, Tiendas, etc. </li>
      ...
      <li>La cantidad de pedidos diarios, semanales o mensuales son ilimitados, siempre que la operadora disponga de codigos ellos le despacharan sus pedidos.</li></ul>
      <li>Tiempo de espera Aprox. 1 dia.</li>
...
'.$boton_contratar.'
  ...
  echo '<hr><div class="alert alert-success" role="alert">
   <h3>SOBRE SU PLAN MOVILNET CONTRATADO</h3>En el periodo correspondiente al mes de <b> '.strtoupper($mes_de_pago_actual).'</b> su tipo de Plan es Afiliacion <b>'.$row['afiliacion'].'
    ...
    if ($titulopag == "Movilnet")
  {
    ...
    <h5>Vigencia de su Plan '.$operador.'</h5>Por ejemplo:<br>Aprobandose su pago hoy: <b>'. $hoy_a .'</b> Su renta venceria el <b>'. $fin_a .'</b><br>Pudiendo disfrutar de  <b>'.$interval . '</b> de su Plan.<br> <br>Si no desea pagar mensualidades por uso de la plataforma ahora tendra la posibilidad de efectuar pedidos para consumo personal<br><br> <a href="pedidos_movilnet_sin_plan.php" ><b><i class="fas fa-hand-point-right"></i> HACER PEDIDOS SIN PAGAR MENSUALIDADES </b></a>
  </div><hr>';
...
function selector_operador(){
  global $concepto, $operador, $link, $multiplo, $num_min, $text_num_min, $ph, $nro, $op, $debe_pagar_operador, $me, $img_card, $montos, $monto_minimo, $titulopag;

  $men_ex = ' el primer corte se hara a las 12:30 pm y el segundo corte a las 05:00 pm, es decir: <ul><li>Usted primero debe registrar en la plataforma los numeros y montos a los cuales se desea efectuar las recargas. </li><li>Luego debe efectuar el pago del lote de recargas, se recomienda efectuar pagos Banesco - Banesco para que la recarga sea efectuada en los horarios de sincronizacion con la operadora.</li></ul>Usted podra efectuar mas de un pago al dia segun los requerimientos de su negocio.';

  if ($operador == "Movilnet"){
    $concepto = "MENS_MOVILNET";
$link = '<a class = "link" href="pedidos_movilnet.php">PEDIDOS MOVILNET</a>';
    }
    ...
    if ($operador == "Movistar"){
        ...
        $debe_pagar_operador = '<div class="alert alert-danger" role="alert"" >	<h3> LO SENTIMOS USTED NO HA EFECTUADO EL PAGO CORRESPONDIENTE AL PERIODO ACTUAL</h3></div><a class="btn btn-outline-primary" href="mensualidad_'.strtolower ($operador) .'.php" role="button">Declare su Pago de Mensualidad Para uso de plataforma '.$operador.'</a>';
    ...
    if ($operador == "Directv"){
        ...
        $monto_minimo = 500;
        $num_min = "[0-9]{12}";
        $text_num_min = "Debe utilizar solo Numeros de tarjetas Directv, debe usar 12 digitos Ejemplo: 123456789123.";
        $op = "TARJ DIRECTV";
        $me = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
...
function planes_operadoras(){
    global $db, $link, $operador, $img_card, $multiplo, $concepto, $num_min, $text_num_min, $ph, $nro, $op, $debe_pagar_operador, $me, $montos, $monto_minimo;
...
function analizar_mensualidad2(){
    global $db, $usua, $mes_de_pago_actual, $limite_basico,
    $limite_avanzado, $limite_vip, $operador, $planes, $fecha_actual_sistema, $concepto, $m_dias_r, $como_pagar, $me;
...
if ($operador == "Movistar")
  {
    ...
    echo $como_pagar;
      //echo "Movistar<br>";
echo '<img src="../images/operadoras/movistar.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
...
echo $m_dias_r;
  ...
  if ($operador == "Digitel")
  {
    analisis_dias_restantes();
    echo $como_pagar;
    echo '<img src="../images/operadoras/digitel.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
    echo $m_dias_r;
  ...
  if ($operador == "Directv")
  {
    analisis_dias_restantes();
    echo $como_pagar;
    echo '<img src="../images/operadoras/directv.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
    echo $m_dias_r;
  ...
  if ($operador == "Inter")
  {
    analisis_dias_restantes();
    echo $como_pagar;
    echo '<img src="../images/operadoras/inter.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">';
    echo $m_dias_r;
...
$tituloA = '<h3>Actualmente usted posee activo un solo plan:</h3>';
} else {
$tituloA = '<h3>Actualmente usted posee activo los siguientes planes:</h3>';
}
echo $tituloA;
...
while ($a = mysqli_fetch_assoc($resul)) {
  ...
  if ($a['DiasRestantes']>0) {
    ...
    echo '<hr>';
    echo $img_ope;
    echo ' De la platafoma <b>'. $operador .'</b> le quedan <b>'.$a['DiasRestantes'].'</b> Restantes para disfrutar de su plan. <b>'.strtoupper($operador).'
    </b>';
    echo '<hr>';
...
$fin_a = date_format($date, 'd/m/Y');
    ...
    echo '<div class="alert alert-success" role="alert">
   <h3>SOBRE SU PLAN '.strtoupper($operador).' CONTRATADO</h3>En el periodo correspondiente al mes de <b> '.strtoupper($mes_de_pago_actual).'</b> su Plan Vence el dia <b>'. $fin_a .'</b>. y puede acceder cuando guste y hacer uso del servicio de recargas <a data-toggle="popover" data-content="Aca podrá ingresar directamente al area de recargas '.strtoupper($operador).'." href="recargas_'.strtolower($operador).'.php"><b>AQUI</b></a> </div><hr>';
...
if ($montoafavor>0) {
  ...
  $mens_monto_favor = "<h4>Usted posee un saldo a favor de $monto_favor Bs.</h4><p>Este saldo sera utilizado de forma automatica para recalcular el monto que usted debe pagar en esta operacion.</p>";
}
